...
const Dashboard = lazy(() => import("./pages/dashboard/dashboard2"));
const Dashboard2 = lazy(() => import("./pages/utility/circle"));
...
const BasicTablePage2 = lazy(() => import("./pages/table/table-basic2"));
...
const BasicWidget2 = lazy(() => import("./pages/widget/basic-widget2"));
...
import Homepage3 from "./pages/dashboard/HomePage3";
function App2() {
  return (
    <main className="App  relative">
      <Routes>
        ...
        <Route path="/*" element={<Layout />}>
          ...
          <Route path="table-basic2" element={<BasicTablePage2 />} />
          <Route path="react-table" element={<TanstackTable />} />
          <Route path="invoice" element={<InvoicePage />} />
          <Route path="invoice-add" element={<InvoiceAddPage />} />
          <Route path="invoice-preview" element={<InvoicePreviewPage />} />
          <Route path="invoice-preview2" element={<InvoicePreviewPage2 />} />
          <Route path="invoice-preview3" element={<InvoicePreviewPage3 />} />
          ...
          <Route path="statistic2" element={<StatisticWidget2 />} />
