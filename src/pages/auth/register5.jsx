...
import RegForm2 from "./common/reg-from3";
    ...
    <>
      ...
      <div className="loginwrapper">
        <div className="lg-inner-column">
          {showElement && (
            <div className=" w-2/3 relative z-[1]">
              <div
        ...
        dark:hover:bg-neutral-800"
          ...
          <div className="right-column relative bg-white dark:bg-slate-800" style={{width: `${100 / 3}%`}}>
            <div className="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
              <div className="auth-box h-full flex flex-col justify-center">
                ...
                <RegForm2 />
                <div
                  className="max-w-[400px] mx-auto font-normal mb-4 text-slate-500 
dark:text-slate-400 2xl:mt-12 mt-6 uppercase text-sm"
                >
                  Not registered yet?
                  <Link
                    to="/"
                ...
                <div className="flex justify-between mx-15 mt-4">
                  <button
                    className="btn btn-dark flex items-center border border-gray-300 rounded-full py-2 px-4 
