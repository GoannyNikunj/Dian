      ...
      <div className="flex space-x-3 px-6 rtl:space-x-reverse">
        ...
        <div className="flex-1 text-start flex">
          ...
          <div className="flex-none ltr:text-right rtl:text-end">
            <span className="block text-xs text-green-700 dark:text-slate-400 font-normal">
              12:20 pm
            </span>
            {unredmessage > 0 && (
              <span className="inline-flex flex-col items-center justify-center text-[10px] font-medium w-4 h-4 bg-[#008069] text-white rounded-full">
                {unredmessage}
              </span>
            )}
          </div>
