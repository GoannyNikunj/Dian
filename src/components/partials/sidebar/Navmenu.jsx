...
const Navmenu = ({ menus }) => {
  ...
  useEffect(() => {
    ...
    document.title = `Byer | ${locationName}`;
        ...
        {menus.map((item, i) => (
          <li
            ...
            className={` single-sidebar-menu 
              ...
              style={{ backgroundColor: "transparent", transition: "background-color 0.3s",borderRadius:"6px" }}
  onMouseEnter={(e) => {
            ...
            {!item.child && !item.isHeadr && (
              <NavLink className="menu-link" to={item.link}>
                <span className="menu-icon flex-grow-0">
                  {/* <Icon icon={item.icon} /> */}
                  <img src={item.icon} alt="SVG Image" style={{width:"20px",height:"20px"}}/>
                </span>
