    ...
    return (
        <div style={{ width: '50%', maxWidth: '200px', height: 'auto', position: 'relative', borderRadius: '50%', backgroundColor: '#FFFFFF', margin: '0 auto' }}>
            ...
            <svg viewBox="0 0 100 100" style={{ width: '100%', height: 'auto', transform: 'rotate(-90deg)' }}>
                ...
                <circle className="progress" cx="50" cy="50" r="40" strokeDasharray="251.2" strokeDashoffset={offset} style={{ fill: 'none', stroke: backgroundColor, strokeWidth: '20', strokeLinecap: 'round', transition: 'stroke-dashoffset 0.5s ease-in-out' }}></circle>
            </svg>
        </div>
    );
}
