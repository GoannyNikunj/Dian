export const menuItems = [
  {
    title: "HomePage",
    icon:"src/assets/images/icon/HomePage.svg",
    link:"HomePage",
    isOpen: true,
    isHide: true,
  },
  {
    title: "User Insight",
    icon:"src/assets/images/icon/User Insight.svg",
    link:"UserInsight",
    isOpen: true,
    isHide: true,
  },
  ...
  },
  {
    ...
    icon:"src/assets/images/icon/Review Analytics.svg",
    link:"ReviewAnalytics",
    isOpen: true,
    isHide: true,
  },
  {
    title: "Whatsapp Marketing Compaign",
    icon:"src/assets/images/icon/Whatsapp Marketing Compaign.svg",
    link:"WhatsappMarketingCompaign1",
    isOpen: true,
    isHide: true,
  },
  {
    title: "Whatsapp Marketing Compaign",
    icon:"src/assets/images/icon/Whatsapp Marketing Compaign.svg",
    link:"WhatsappMarketingCompaign2",
    isOpen: true,
    isHide: true,
  },
  {
    title: "Competitor Analysis",
    icon:"src/assets/images/icon/Competitor Analysis.svg",
    link:"CompetitorAnalysis",
    isOpen: true,
    isHide: true,
  },
  {
    title: "Marketing Analytics",
    icon:"src/assets/images/icon/Marketing Analytics.svg",
    link:"MarketingAnalytics",
    isOpen: true,
    isHide: true,
  },
  {
    title: "Invoices",
    icon:"src/assets/images/icon/Invoices.svg",
    link:"Invoices",
    isOpen: true,
    isHide: true,
  },
  {
    title: "Inbox",
    icon:"src/assets/images/icon/Inbox.svg",
    link:"Inbox",
    isOpen: true,
    isHide: true,
  },
  {
    title: "Admin01",
    icon:"src/assets/images/icon/Profile.svg",
    link:"Admin01",
    isOpen: true,
    isHide: true,
  },
  ...
  {
    title: "",
    icon:"src/assets/images/icon/HomePage2.svg",
    link:"",
    isOpen: true,
    isHide: true,
  },
